...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cpu=loongson3 --enable-mmi
prefix=/usr/local
...
CC_IDENT=gcc 5.2.1 (Debian 5.2.1-23) 20151028
ARCH=mips
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=   -march=loongson3a -mhard-float -fno-expensive-optimizations -std=c99 -fomit-frame-pointer -fPIC -pthread  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=   -march=loongson3a -mhard-float -fno-expensive-optimizations -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS=  -march=loongson3a -mhard-float -fno-expensive-optimizations -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -ljack -lasound -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
NOREDZONE_FLAGS=
libavcodec_VERSION=57.17.100
libavcodec_VERSION_MAJOR=57
libavcodec_VERSION_MINOR=17
libavdevice_VERSION=57.0.100
libavdevice_VERSION_MAJOR=57
libavdevice_VERSION_MINOR=0
libavfilter_VERSION=6.20.100
libavfilter_VERSION_MAJOR=6
libavfilter_VERSION_MINOR=20
libavformat_VERSION=57.19.100
